...
doors_image_paths = {
    ...
    '5more': get_relative_path('images\\5_more_doors.png')
}
...
lug_boot_image_paths = {
    ...
    'med': get_relative_path('images\\medium_lug_boot.png'),
    'big': get_relative_path('images\\big_lug_boot.png')
}

safety_image_paths = {
    'low': get_relative_path('images\\low_safety.png'),
    'med': get_relative_path('images\\medium_safety.png'),
...
def main():
    ...
    if choices == 'EDA':
        ...
        data = load_data('C:/Users/faruk/OneDrive/Masaüstü/car_app/data/car.data')
    ...
    if choices == 'Prediction':
        ...
        if st.button("Evaluate"):
            if model_choice == 'LogisticRegression':
                predictor = load_prediction_model("C:/Users/faruk/OneDrive/Masaüstü/car_app/models/LogisticRegression.pkl")
                prediction = predictor.predict(prep_data)
            
            elif model_choice == 'Naive Bayes':
                predictor = load_prediction_model("C:/Users/faruk/OneDrive/Masaüstü/car_app/models/NaiveBayes.pkl")
                prediction = predictor.predict(prep_data)
            
            elif model_choice == 'MLP Classifier':
                predictor = load_prediction_model("C:/Users/faruk/OneDrive/Masaüstü/car_app/models/MLPClassifier.pkl")
                prediction = predictor.predict(prep_data)

            st.write(prediction)
            final_result = map_class_label(get_key(prediction,class_label))
